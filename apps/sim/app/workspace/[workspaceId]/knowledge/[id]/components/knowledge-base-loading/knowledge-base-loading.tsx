              ...
              <div className='mb-4 flex items-center justify-between pt-1'>
                ...
                <div className='flex items-center gap-3'>
                  ...
                  <Button
                    disabled
                    size='sm'
                    className='flex items-center gap-1 bg-[var(--brand-primary-hex)] font-[480] text-muted-foreground shadow-[0_0_0_0_var(--brand-primary-hex)] transition-all duration-200 hover:bg-[var(--brand-primary-hover-hex)] hover:shadow-[0_0_0_4px_var(--brand-primary-hex-a10)] disabled:opacity-50'
                  >
